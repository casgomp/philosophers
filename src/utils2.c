...
/*   Updated: 2025/12/12 19:59:14 by pecastro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_critical(t_philo *philos, char *str)
{
	...
	if (philos->phargs->state != 1)
		printf("%dms %d %s\n", get_time_relative(philos->phargs), 
			philos->idxph + 1, str);
