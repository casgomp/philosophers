...
/*   Updated: 2025/12/12 19:27:26 by pecastro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int	routine_philo_loop(t_philo *philos, 
					pthread_mutex_t *fork_low, pthread_mutex_t *fork_high);
unsigned int	philo_has_two_forks(t_philo *philos, 
					pthread_mutex_t *fork_low, pthread_mutex_t *fork_high);
//time.c
